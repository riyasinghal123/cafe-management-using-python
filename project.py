...
root = Tk()
      # Geometric measurement of the system created

root.title("Cafe Management System")# Title is set

# Load the image
background_image_path = r"C:\Users\hp\Pictures\Screenshots\cafe.png"
...
Tops = Frame(root, width=135, height=100,padx=20,pady=10, relief="ridge")
Tops.pack(side=TOP)

f1 = Frame(root, width=900, height=650,padx=20,pady=10, relief="raise")
f1.pack(side=LEFT)

f2 = Frame(root, width=440, height=650,padx=20,pady=10, relief="raise")
f2.pack(side=RIGHT)

f1a = Frame(f1, width=900, height=330,padx=20,pady=10, relief="raise")
f1a.pack(side=TOP)

f2a = Frame(f1, width=900, height=320,padx=20,pady=10,  relief="raise")
f2a.pack(side=BOTTOM)

ft2 = Frame(f2, width=440, height=450,padx=20,pady=10, relief="raise")
ft2.pack(side=TOP)

fb2 = Frame(f2, width=440, height=250, relief="raise")
fb2.pack(side=BOTTOM)

f1aa = Frame(f1a, width=400, height=330, relief="raise")
f1aa.pack(side=LEFT)

f1ab = Frame(f1a, width=400, height=330, relief="raise")
f1ab.pack(side=RIGHT)

f2aa = Frame(f2a, width=450, height=330, relief="raise")
f2aa.pack(side=LEFT)

f2ab = Frame(f2a, width=450, height=330, relief="raise")
...
lblInfo = Label(Tops, font=('arial', 50), text="Welcome to our Cafe!", bd=2)
...
def CostofItems():
    ...
    Tax = "Rs.", str('%0.2f' % ((PriceofFood + PriceofCakesandDrinks + 0.5)*0.18))
    PaidTax.set(Tax)
    TT = ((PriceofFood + PriceofCakesandDrinks + 0.15)*0.18)
    TC = "Rs.", str('%0.2f' % ((PriceofFood + PriceofCakesandDrinks + 0.10) + TT))
    print((TC))
    TotalCost.set(TC)
...
Fries = Checkbutton(f1aa, font=('arial',15), text="Fries Meal \t", variable=var1, onvalue=1,
                    offvalue=0, command=chkbutton_value).grid(row=0, sticky=W)

Lunch = Checkbutton(f1aa, font=('arial', 15), text="Lunch Meal \t", variable=var2, onvalue=1,
                       offvalue=0, command=chkbutton_value).grid(row=1, sticky=W)

Burger = Checkbutton(f1aa, font=('arial', 15), text="Burger Meal \t", variable=var3, onvalue=1,
                         offvalue=0, command=chkbutton_value).grid(row=2, sticky=W)

Pizza = Checkbutton(f1aa, font=('arial', 15), text="Pizza Meal \t", variable=var4, onvalue=1,
                          offvalue=0, command=chkbutton_value).grid(row=3, sticky=W)

CheeseBurger = Checkbutton(f1aa, font=('arial', 15), text="Cheese Burger  \t", variable=var5, onvalue=1,
                         offvalue=0, command=chkbutton_value).grid(row=4, sticky=W)

MacNuggets = Checkbutton(f1aa, font=('arial', 15), text="Mac Nuggets \t", variable=var6, onvalue=1,
                             offvalue=0, command=chkbutton_value).grid(row=5, sticky=W)

MacPuff = Checkbutton(f1aa, font=('arial', 15), text="Mac Puff \t", variable=var7, onvalue=1,
                              offvalue=0, command=chkbutton_value).grid(row=6, sticky=W)

ChickenWings = Checkbutton(f1aa, font=('arial', 15), text="Chicken Wings \t", variable=var8, onvalue=1,
                              offvalue=0, command=chkbutton_value).grid(row=7, sticky=W)

# ====================================== Drinks & Cake Check Buttons ================================================

CoffeeCake = Checkbutton(f1ab, font=('arial', 15), text="Coffee Cake \t", variable=var9, onvalue=1,
                         offvalue=0, command=chkbutton_value).grid(row=0, sticky=W)

Red_Velvet_Cake = Checkbutton(f1ab, font=('arial', 15), text="Red Velvet Cake \t", variable=var10, onvalue=1,
                              offvalue=0, command=chkbutton_value).grid(row=1, sticky=W)

Black_Forest_Cake = Checkbutton(f1ab, font=('arial', 15), text="Black Forest Cake \t", variable=var11,
                                onvalue=1, offvalue=0, command=chkbutton_value).grid(row=2, sticky=W)

Boston_Cream_Cake = Checkbutton(f1ab, font=('arial', 15), text="Boston Cream Cake \t", variable=var12, onvalue=1,
                                offvalue=0, command=chkbutton_value).grid(row=3, sticky=W)

Latta = Checkbutton(f1ab, font=('arial', 15), text="Latte \t", variable=var13,
                                   onvalue=1, offvalue=0, command=chkbutton_value).grid(row=4, sticky=W)

Coke = Checkbutton(f1ab, font=('arial', 15), text="Coke \t", variable=var14,
                                     onvalue=1, offvalue=0, command=chkbutton_value).grid(row=5, sticky=W)

Pepsi = Checkbutton(f1ab, font=('arial', 15), text="Pepsi \t", variable=var15, onvalue=1,
                                offvalue=0, command=chkbutton_value).grid(row=6, sticky=W)

Cappuccino = Checkbutton(f1ab, font=('arial', 15), text="Cappuccino \t", variable=var16,
                              onvalue=1, offvalue=0, command=chkbutton_value).grid(row=7, sticky=W)

# ====================================== Entry Widget for Food ===================================================

txtFries = Entry(f1aa, font=('arial', 16), width=6, justify='left', textvariable=E_Fries, state=DISABLED)
txtFries.grid(row=0, column=1)
txtLunch = Entry(f1aa, font=('arial', 16), width=6, justify='left', textvariable=E_Lunch,
                    state=DISABLED)
txtLunch.grid(row=1, column=1)
txtBurger = Entry(f1aa, font=('arial', 16), width=6, justify='left', textvariable=E_Burger,
                      state=DISABLED)
txtBurger.grid(row=2, column=1)
txtPizza = Entry(f1aa, font=('arial', 16), width=6, justify='left', textvariable=E_Pizza,
                       state=DISABLED)
txtPizza.grid(row=3, column=1)
txtCheeseBurger = Entry(f1aa, font=('arial', 16), width=6, justify='left', textvariable=E_CheeseBurger,
                      state=DISABLED)
txtCheeseBurger.grid(row=4, column=1)
txtMacNuggets = Entry(f1aa, font=('arial', 16), width=6, justify='left', textvariable=E_MacNuggets
                          , state=DISABLED)
txtMacNuggets.grid(row=5, column=1)
txtMacPuff = Entry(f1aa, font=('arial', 16) ,width=6, justify='left',
                           textvariable=E_MacPuff, state=DISABLED)
txtMacPuff.grid(row=6, column=1)
txtChickenWings = Entry(f1aa, font=('arial',16), width=6, justify='left',
                           textvariable=E_ChickenWings, state=DISABLED)
txtChickenWings.grid(row=7, column=1)

# ====================================== Entry Widget for Cakes ===================================================

txtCoffee_Cake = Entry(f1ab, font=('arial', 16), width=6, justify='left',
                       textvariable=E_Coffee_Cake, state=DISABLED)
txtCoffee_Cake.grid(row=0, column=1)
txtRed_Valet_Cake = Entry(f1ab, font=('arial', 16), width=6, justify='left',
                          textvariable=E_Red_Velvet_Cake, state=DISABLED)
txtRed_Valet_Cake.grid(row=1, column=1)
txtBlack_Forest_Cake = Entry(f1ab, font=('arial', 16), width=6, justify='left',
                             textvariable=E_Black_Forest, state=DISABLED)
txtBlack_Forest_Cake.grid(row=2, column=1)
txtBoston_Cream_Cake = Entry(f1ab, font=('arial', 16), width=6, justify='left',
                             textvariable=E_Boston_Cream_Cake, state=DISABLED)
txtBoston_Cream_Cake.grid(row=3, column=1)
txtLatta = Entry(f1ab, font=('arial', 16),width=6, justify='left',
                                textvariable=E_Latta, state=DISABLED)
txtLatta.grid(row=4, column=1)
txtCoke = Entry(f1ab, font=('arial', 16), width=6, justify='left',
                                 textvariable=E_Coke, state=DISABLED)
txtCoke.grid(row=5, column=1)
txtPepsi = Entry(f1ab, font=('arial', 16), width=6, justify='left',
                             textvariable=E_Pepsi, state=DISABLED)
txtPepsi.grid(row=6, column=1)
txtCappuccino = Entry(f1ab, font=('arial', 16), width=6, justify='left',
                           textvariable=E_Cappuccino, state=DISABLED)
txtCappuccino.grid(row=7, column=1)

# ========================================== Receipt Information ====================================================

lblReceipt = Label(ft2, font=('arial', 12), text="Receipt", bd=2, anchor='w')
lblReceipt.grid(row=0, column=0, sticky=W)
txtReceipt = Text(ft2, width=59, height=22, bg="white", font=('arial', 11, 'bold'))
txtReceipt.grid(row=1, column=0)

# =================================== Cost Items Information(f2aa) ==================================================

lblCostofFood = Label(f2aa, font=('arial', 16), text="Cost of Food", bd=8)
lblCostofFood.grid(row=2, column=0, sticky=W)
txtCostofFood = Entry(f2aa, font=('arial', 16), justify="left", textvariable=CostofFood)
txtCostofFood.grid(row=2, column=1, sticky=W)

lblCostofCakesandDrinks = Label(f2aa, font=('arial', 16), text="Drink & Cake", bd=8)
lblCostofCakesandDrinks.grid(row=3, column=0, sticky=W)
txtCostofCakesandDrinks = Entry(f2aa, font=('arial', 16), justify="left", textvariable=CostofCakesandDrinks)
txtCostofCakesandDrinks.grid(row=3, column=1, sticky=W)

lblServiceCharge = Label(f2aa, font=('arial', 16), text="Service Charge", bd=8)
lblServiceCharge.grid(row=4, column=0, sticky=W)
txtServiceCharge = Entry(f2aa, font=('arial', 16), justify="left", textvariable=ServiceCharge)
txtServiceCharge.grid(row=4, column=1, sticky=W)

# ======================================Payment Information(f2ab)===================================================

lblPaidTax = Label(f2ab, font=('arial', 16), text="Tax", bd=8)
lblPaidTax.grid(row=2, column=0, sticky=W)
txtPaidTax = Entry(f2ab, font=('arial', 16), justify="left", textvariable=PaidTax)
txtPaidTax.grid(row=2, column=1, sticky=W)

lblSubTotal = Label(f2ab, font=('arial', 16), text="Sub Total", bd=8)
lblSubTotal.grid(row=3, column=0, sticky=W)
txtSubTotal = Entry(f2ab, font=('arial', 16), justify="left", textvariable=SubTotal)
txtSubTotal.grid(row=3, column=1, sticky=W)

lblTotalCost = Label(f2ab, font=('arial', 16), text="Total", bd=8)
lblTotalCost.grid(row=4, column=0, sticky=W)
txtTotalCost = Entry(f2ab, font=('arial', 16),justify="left", textvariable=TotalCost)
txtTotalCost.grid(row=4, column=1, sticky=W)


# ======================================Button===================================================

btnTotal = Button(fb2, padx=16, pady=1, bd=4, fg="black", font=('arial', 16), width=5,
                  text="Total", command=CostofItems).grid(row=0, column=0)
btnReceipt = Button(fb2, padx=16, pady=1, bd=4, fg="black", font=('arial', 16), width=5,
                    text="Receipt", command=Receipt).grid(row=0, column=1)
btnReset = Button(fb2, padx=16, pady=1, bd=4, fg="black", font=('arial', 16), width=5,
                  text="Reset", command=Reset).grid(row=0, column=2)
btnExit = Button(fb2, padx=16, pady=1, bd=4, fg="black", font=('arial', 16), width=5,
